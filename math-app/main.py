...
def _carte(i: int, slug: str, glyphe: str, titre: str, sous_titre: str, domaine: str) -> str:
    ...
    return (
        f'<a class="ma-card" style="--i:{i}" href="/{slug}" target="_self">'
...
hero = (
    ...
    + '<div class="ma-cta">'
    + '<a class="ma-btn-primary" href="/Dérivée" target="_self">Commencer un calcul</a>'
    + '<a class="ma-btn-ghost" href="/Formulaire" target="_self">Voir le formulaire</a>'
    + '</div>'
...
contenu = (
    ...
    + '<a class="ma-banner" href="/Formulaire" target="_self">'
    ...
    + '<a class="ma-banner" href="/Entraînement" target="_self" style="animation-delay: 720ms">'
